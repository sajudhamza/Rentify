...
export const AuthModal = ({ isOpen, onClose, apiBaseUrl, onLoginSuccess }) => {
    ...
    const handleSignIn = async (e) => {
        ...
        try {
            ...
            // Persist session directly in localStorage for robustness
            localStorage.setItem('rentifyUser', JSON.stringify(userData));
            localStorage.setItem('rentifyToken', access_token);

            // Pass user and token to parent to update app state
            if (onLoginSuccess) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md relative animate-fade-in-up">
                ...
                <div className="p-8">
                    ...
                    <form onSubmit={isLoginView ? handleSignIn : handleRegister}>
                        {!isLoginView && (
                             <>
                                <div className="mb-4">
